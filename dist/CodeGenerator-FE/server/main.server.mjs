...
import {
  AuthService,
  ROUTES
} from "./chunk-FGYCZM37.mjs";
import "./chunk-SQ7M6K5U.mjs";
import {
  ActivatedRoute,
  BrowserDomAdapter,
  BrowserModule,
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      if (isNgModule(bootstrap2)) {
        ...
        applicationRef = yield bootstrap2({ platformRef });
      }
...
var routes = [
  ...
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-UR66PKK5.mjs").then((m) => m.LandingComponent)
  }, true ? { \u0275entryName: "src/app/features/landing/landing.component.ts" } : {}),
  // Auth routes (only for guests)
  __spreadValues({
    path: "auth/login",
    loadComponent: () => import("./chunk-BPBTMKXI.mjs").then((m) => m.LoginComponent),
    canActivate: [guestGuard]
  }, true ? { \u0275entryName: "src/app/features/auth/login.component.ts" } : {}),
  // Protected routes (require authentication)
  __spreadValues({
    path: "dashboard",
    loadComponent: () => import("./chunk-XLXEL3JD.mjs").then((m) => m.DashboardComponent),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/app/features/dashboard/dashboard.component.ts" } : {}),
  // Code Generator Flow (protected)
  __spreadValues({
    path: "code-type",
    loadComponent: () => import("./chunk-N7B2UZGQ.mjs").then((m) => m.CodeTypeComponent),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/app/features/code-type/code-type.component.ts" } : {}),
  __spreadValues({
    path: "code-type-attribute",
    loadComponent: () => import("./chunk-AIOQJ3MS.mjs").then((m) => m.CodeTypeAttributeComponent),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/app/features/code-type-attribute/code-type-attribute.component.ts" } : {}),
  __spreadValues({
    path: "code-type-main",
    loadComponent: () => import("./chunk-MYIHXAAO.mjs").then((m) => m.CodeTypeMainComponent),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/app/features/code-type-main/code-type-main.component.ts" } : {}),
  __spreadValues({
    path: "code-details",
    loadComponent: () => import("./chunk-QEWI2RI2.mjs").then((m) => m.CodeDetailsComponent),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/app/features/code-details/code-details.component.ts" } : {}),
  __spreadValues({
    path: "code-settings",
    loadComponent: () => import("./chunk-RLBGW2WI.mjs").then((m) => m.CodeSettingsComponent),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/app/features/code-settings/code-settings.component.ts" } : {}),
  __spreadValues({
    path: "code-sequence",
    loadComponent: () => import("./chunk-2IUBNCOF.mjs").then((m) => m.CodeSequenceComponent),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/app/features/code-sequence/code-sequence.component.ts" } : {}),
  __spreadValues({
    path: "code-generation",
    loadComponent: () => import("./chunk-QEYPV6LL.mjs").then((m) => m.CodeGenerationComponent),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/app/features/code-generation/code-generation.component.ts" } : {}),
  // Other protected routes
  __spreadValues({
    path: "settings",
    loadComponent: () => import("./chunk-DF75ARZQ.mjs").then((m) => m.SettingsComponent),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/app/features/settings/settings.component.ts" } : {}),
